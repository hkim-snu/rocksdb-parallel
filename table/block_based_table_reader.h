...
class BlockBasedTable : public TableReader {
 public:
  ...
  static BlockIter* NewDataBlockIterator_compaction(Rep* rep, const ReadOptions& ro,
                                         const BlockHandle& block_hanlde,
                                         BlockIter* input_iter = nullptr,
                                         bool is_index = false,
                                         GetContext* get_context = nullptr,
...
class BlockBasedTableIterator : public InternalIterator {
 public:
  ...
  void SeekToFirst_compaction() override;
  void SeekToLast() override;
  void Next() override;
  void Next_compaction();
  void Prev() override;
  ...
  void InitDataBlock();
  void InitDataBlock_compaction();
  void FindKeyForward();
  void FindKeyForward_compaction();
